...
MEDIA_ROOT = env("STATIC_ROOT", default=str(APPS_DIR / "media"))
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "themagicai.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""Bakhtiyor Ergashev""", "baxtikdev@example.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "themagicai.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "themagicai.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "themagicai.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "themagicai.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "THE MAGIC AI API",
    "DESCRIPTION": "Documentation of API endpoints of themagicai",
    "VERSION": "1.0.0",
